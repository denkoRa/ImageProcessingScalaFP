...
import com.denkora.image.{Image, LayerFactory, SelectionFactory}
...
//  s1.deactivate()
  val f = FilterManager
  f.setSelection(sm.getSelections())
  s1.deactivate()
//  ss.deactivate()
//  ss.activate()
...
//    val i = LayerFactory.mergeLayers("result.png")
...
//////  Image.save(img, "result.png")
    ...
    o.sequenceOp("sekvenca", names = ArrayBuffer("add", "inversion", "add"), consts = ArrayBuffer(1, 0, 0.2))
      o.applySequence("sekvenca", l)
      LayerFactory.mergeLayers("result.png")
